...
XtraData equ ScreenData+$2000
    ...
    ; link a demo picture
    incbin "$DATAFILE"
`;function we(t,i){return i||(i=2),Hi(t,i,16)}function Hi(t,i,x){try{for(var l=t.toString(x).toUpperCase();l.length<i;)l="0"+l;return l}catch(f){return t+""}}function qe(t,i){return t.map(x=>i.indexOf(x&16777215))}function er(){return Xa}function Xi(){var t=er();return t=t.replace("lda #$18","lda #$08").replace("multicolor","single"),t}function Wi(){return Wa}function ji(){var t=ja,i=qe(ne.lastPixels.pal,ne.settings.pal);return t=t.replace("hex 1f;screen color","hex "+we(i[0])),t=t.replace("hex 01112100;background 0","hex "+we(i[1])+we(i[2])+we(i[3])+we(0)),t}function Vi(){return Va}function zi(){var t=za,i=qe(ne.lastPixels.pal,ne.settings.pal);return t=t.replace("#$F6","#$"+we(i[0])),t=t.replace("#$F7","#$"+we(i[1])),t}function Yi(){var t=Ya,i=qe(ne.lastPixels.pal,ne.settings.pal);return t=t.replace("$b0","$"+we(i[0])),t=t.replace("$b1","$"+we(i[1])),t=t.replace("$b2","$"+we(i[2])),t=t.replace("$b3","$"+we(i[3])),t}function tr(){for(var t=qa,i=qe(ne.lastPixels.pal,ne.settings.pal),x=0;x<i.length;x++)t=t.replace("$00;PF"+x,"$"+we(i[x]));return t}function qi(){let t=tr();return t=t.replace(".byte $4d",".byte $4f"),t=t.replace(".byte $0d",".byte $0f"),t=t.replace("#$00;PRIOR","#$80"),t=t.replace("COLOR0+4","PCOLR0+0"),t=t.replace("COLOR0+0","PCOLR0+1"),t=t.replace("COLOR0+1","PCOLR0+2"),t=t.replace("COLOR0+2","PCOLR0+3"),t=t.replace(";GPIOMODE equ 1","GPIOMODE equ 1"),t}function st(){var t=Za;return t}function Zi(){return st()}function Ki(){return st()}function Ji(){return st()}function en(){return st()}function $t(t){var i=Ka,x=qe(ne.lastPixels.pal,ne.settings.pal);i=i.replace("$MODE",t+"");for(var l=0;l<16;l++)i=i.replace("$c"+l,"$"+we(x[l]||0));return i}function tn(t){return $t(0)}function an(t){return $t(1)}function Qe(){var t=Ja;return t}function rn(){let t=Qe();return t=t.replace("$USE_MULTI_MODE","0"),t}function nn(){let t=Qe();return t=t.replace("$USE_MULTI_MODE","0"),t}function on(){let t=Qe();return t=t.replace("$USE_MULTI_MODE","0"),t}function sn(){let t=Qe();return t=t.replace("$USE_MULTI_MODE","1"),t}function ln(){let t=Qe();return t=t.replace("$USE_MULTI_MODE","1"),t}function cn(){let t=Qe();return t=t.replace("$USE_MULTI_MODE","1"),t}function hn(){let t=Qe();return t=t.replace("$USE_MULTI_MODE","1"),t}var ar=[[1,0,.4375],[-1,1,.1875],[0,1,.3125],[1,1,.0625]],rr=[[1,0,3/8],[0,1,3/8],[1,1,2/8]],ir=[[1,0,1/6],[2,0,1/6],[-1,1,1/6],[0,1,1/6],[1,1,1/6],[0,2,1/6]],nr=[[1,0,4/16],[2,0,3/16],[-2,1,1/16],[-1,1,2/16],[0,1,3/16],[1,1,2/16],[2,1,1/16]],or=[[1,0,2/4],[-1,1,1/4],[0,1,1/4]],sr=[[1,0,8/42],[2,0,4/42],[-2,1,2/42],[1,-1,4/42],[0,1,8/42],[1,1,4/42],[2,1,2/42],[-2,2,1/42],[-1,2,2/42],[0,2,4/42],[1,2,2/42],[2,2,1/42]],lr=[[1,0,.5],[0,1,.5]],cr=[[1,0,1]],hr=[[0,1,1]],fr=[[0,1,2/4],[0,2,1/4],[1,2,1/4]],ur=[[1,1,1]],dr=[[0,1,6/16],[-1,1,3/16],[1,1,3/16],[-2,2,1/16],[0,2,2/16],[2,2,1/16]];var br=Tt(pr()),wr=Tt(mr()),qt=Tt(gr());var xr=["benbenn.jpg","cezanne2.jpg","colorroses.jpg","colorswirls.jpg","coolcar.jpg","darkbrewery.jpg","dhuku.jpg","greentruck.jpg","frida.jpg","homer.jpg","keyssunset.jpg","lobsterpot.jpg","myersflat.jpg","myrtle.jpg","parrot.jpg","redrose.jpg","robert_s_duncanson.jpg","seurat.jpg","vangogh.jpg"];var ye,un=document.getElementById("brightSlider"),dn=document.getElementById("contrastSlider"),pn=document.getElementById("saturationSlider"),An=document.getElementById("noiseSlider"),mn=document.getElementById("diffuseSlider"),gn=document.getElementById("orderedSlider"),xn=document.getElementById("diversitySlider"),vn=document.getElementById("imageUpload"),Cr=document.getElementById("srcimage"),ft=document.getElementById("resizecanvas"),ct=document.getElementById("destcanvas"),Yt=class{constructor(i){i.onmessage=x=>{var l=x.data;l!=null&&l.img!=null&&this.pixelsAvailable!=null&&(this.pixelsAvailable(l),this.lastPixels=l)}}setSettings(i){this.settings=i,vt.postMessage({cmd:"setSettings",data:i})}setSourceImage(i){vt.postMessage({cmd:"setSourceImage",data:i})}restart(){vt.postMessage({cmd:"restart"})}},vt=new Worker("./gen/worker.js"),ne=new Yt(vt),lt,bt,Ir=[{name:"Floyd-Steinberg",kernel:ar},{name:"False Floyd",kernel:rr},{name:"Atkinson",kernel:ir},{name:"Sierra 2",kernel:nr},{name:"Sierra Lite",kernel:or},{name:"Stucki",kernel:sr},{name:"Two-D",kernel:lr},{name:"Right",kernel:cr},{name:"Down",kernel:hr},{name:"Double Down",kernel:fr},{name:"Diagonal",kernel:ur},{name:"Diamond",kernel:dr}],bn=[{id:"perceptual",name:"Perceptual"},{id:"hue",name:"Hue-Based"},{id:"dist",name:"Distance"},{id:"max",name:"Maximum"}];function wn(t){return new Uint32Array(t.getContext("2d").getImageData(0,0,t.width,t.height).data.buffer)}function Cn(t,i){var x=t.getContext("2d"),l=x.createImageData(t.width,t.height),f=new Uint32Array(l.data.buffer);f.length==i.length?(f.set(i),x.putImageData(l,0,0)):console.log("drawRGBA(): array length mismatch")}function In(t,i,x,l,f){i*=1,x*=1;for(var E=new Uint8ClampedArray(t.buffer),g=0;g<E.length;g+=4){var p=E[g],s=E[g+1],A=E[g+2];if(l!=1){var c=.2989*p+.587*s+.114*A;p=c*(1-l)+p*l,s=c*(1-l)+s*l,A=c*(1-l)+A*l}E[g]=Math.pow(p*i,f)+x,E[g+1]=Math.pow(s*i,f)+x,E[g+2]=Math.pow(A*i,f)+x}}function Ze(){var t=wn(ft);let i=(parseFloat(dn.value)-50)/100+1,x=(parseFloat(un.value)-i*50)*(128/50),l=(parseFloat(pn.value)-50)/50+1;In(t,i,x,l,1),ne.setSourceImage(t),We()}function We(){var t=$("#diffuseTypeSelect")[0].selectedOptions[0];t&&(ne.settings.ditherfn=Ir[parseInt(t.value)].kernel);var t=$("#errorFuncSelect")[0].selectedOptions[0];t&&(ne.settings.errfn=t.value),ne.settings.diffuse=parseFloat(mn.value)/100,ne.settings.ordered=parseFloat(gn.value)/100,ne.settings.noise=parseFloat(An.value),ne.settings.paletteDiversity=parseFloat(xn.value)/200+.75,ne.setSettings(ne.settings),ne.restart()}function En(){let t=ye==null?void 0:ye.getCroppedCanvas();!(t!=null&&t.width)||!(t!=null&&t.height)||(0,wr.default)().resize(t,ft,{}).then(()=>{Ze()})}function Er(t){var i=t.width+" x "+t.height;return t.reduce?i+=", "+t.reduce+" out of "+t.pal.length+" colors":t.pal&&(i+=", "+t.pal.length+" colors"),t.block&&(i+=", ",i+=t.block.colors+" colors per ",i+=t.block.w+"x"+t.block.h+" block"),i}function yn(t){$("#targetFormatInfo").text(Er(t))}function _n(t){var i=$("#paletteSwatches");i.empty(),t&&t.length<64&&t.forEach((x,l)=>{var f="rgb("+(x&255)+","+(x>>8&255)+","+(x>>16&255)+")",E=$('<span style="width:2em">&nbsp;</span>').css("background-color",f);i.append(E)})}function Bn(t){let i=ne.settings;return(t==null?void 0:t.naturalWidth)==i.width&&(t==null?void 0:t.naturalHeight)==i.height}function Dn(){console.log("Width and height exact match!"),ye.clear(),ye.disable(),ft.getContext("2d").drawImage(Cr,0,0),Ze()}function wt(t){ye&&ye.destroy();let i=ne.settings,x=i.width*(i.scaleX||1)/i.height||4/3;ye=new br.default(Cr,{viewMode:1,autoCropArea:1,initialAspectRatio:x,crop(l){Bn(ye.getImageData())?Dn():En()}}),ye.replace(t),Br()}function vr(t){var i=t.conv!="DitheringCanvas";ne.setSettings(t),ne.restart(),yn(t),ft.width=ct.width=t.width,ft.height=ct.height=t.height;let x=t.scaleX||1;ct.style.aspectRatio=(t.width*x/t.height).toString(),$("#noiseSection").css("display",i?"flex":"none"),$("#diversitySection").css("display",t.reduce?"flex":"none"),$("#downloadNativeBtn").css("display",t.toNative?"inline":"none"),$("#gotoIDE").css("display",_r()?"inline":"none"),ye&&wt(ye.url),Br(),kn(t)}function ht(){var t=lt||"image";try{t=t.split(".").shift()||"image"}catch(i){}return t+"-"+ne.settings.id}function yr(){var t=ne.lastPixels;let i=ne.settings.toNative;if(!i)return null;var x=Ut[i];return t&&x&&x(t,ne.settings)}function Mn(){var t=yr();if(t!=null){var i=new Blob([t],{type:"application/octet-stream"});(0,qt.saveAs)(i,ht()+".bin")}}function Fn(){ct.toBlob(t=>{(0,qt.saveAs)(t,ht()+".png")},"image/png")}function Rn(t){var i="";if(t!=null){for(var x=new Array,l=0;l<256;++l)x[l]=String.fromCharCode(l);for(var f=t.length,l=0;l<f;l++)i+=x[t[l]]}return i}function _r(){var t="getFileViewerCode_"+ne.settings.id.replace(/[^a-z0-9]/g,"_"),i=Ht[t];return i}async function Sn(){function t(g,p,s){$('<input type="hidden"/>').attr("name",p).val(s).appendTo(g)}if(confirm("Open code sample with image in 8bitworkshop?")){var i=ne.settings.id.split(".")[0],x=$(document.forms.ideForm);x.empty(),i=="atari8"&&(i="atari8-800"),i=="cpc"&&(i="cpc.6128"),t(x,"platform",i);var l="viewer-"+ht()+".asm",f=ht()+".bin";t(x,"file0_name",l);var E=_r()();E=E.replace("$DATAFILE",ht()+".bin"),t(x,"file0_data",E),t(x,"file0_type","utf8"),t(x,"file1_name",f),t(x,"file1_data",btoa(Rn(yr()))),t(x,"file1_type","binary"),x.submit()}}function Br(){let t={sys:ne.settings.id,image:bt};window.location.hash="#"+$.param(t)}function Tn(t){t.startsWith("?")&&(t=t.substr(1));var i=t.split("&");if(!i||i.length==0)return{};for(var x={},l=0;l<i.length;++l){var f=i[l].split("=",2);f.length==1?x[f[0]]="":x[f[0]]=decodeURIComponent(f[1].replace(/\+/g," "))}return x}function kn(t){let i=$("#targetFormatSelect");i.empty();let[x,l]=t.name.split(" ("),f=new Set,E=null;it.forEach(g=>{if(g==null)i.append($("<option disabled></option>"));else{let[p,s]=g.name.split(" ("),A=$("<option />").text(g.name).val(g.id);if(p==x)E||(E=$("<optgroup />").attr("label",x),i.append(E)),E.append(A);else if(!f.has(p)){let c=$("<option />").text(p).val(g.id);i.append(c)}f.add(p)}}),i.val(t.id)}function On(){if(window.addEventListener("load",function(){document.querySelector('input[type="file"]').addEventListener("change",function(f){var E=f.target,g=E.files&&E.files[0];if(g){lt=g.name,bt="";var p=URL.createObjectURL(g);wt(p)}}),xr.forEach(f=>{$('<a class="dropdown-item" href="#"></a>').text(f).appendTo("#examplesMenu")}),$("#examplesMenu").click(f=>{var E=$(f.target).text();lt=bt=E,wt("images/"+E),vn.value=""}),Ir.forEach((f,E)=>{var g=$("<option />").text(f.name).val(E);$("#diffuseTypeSelect").append(g)}),bn.forEach((f,E)=>{var g=$("<option />").text(f.name).val(f.id);$("#errorFuncSelect").append(g)}),ne.pixelsAvailable=f=>{Cn(ct,f.img),_n(f.pal)};let i=Tn(window.location.hash.substring(1)),x=i.sys||it[0].id,l=gt[x];vr(l),lt=bt=i.image||"seurat.jpg",wt("images/"+lt),$("#diffuseSlider").on("change",We),$("#orderedSlider").on("change",We),$("#noiseSlider").on("change",We),$("#diversitySlider").on("change",Ze),$("#brightSlider").on("change",Ze),$("#contrastSlider").on("change",Ze),$("#saturationSlider").on("change",Ze),$("#resetButton").on("click",We),$("#diffuseTypeSelect").on("change",We),$("#targetFormatSelect").change(f=>{var E=f.target.selectedOptions[0];E&&vr(gt[E.value])}),$("#errorFuncSelect").on("change",We),$("#downloadImageBtn").click(Fn),$("#downloadNativeBtn").click(Mn),$("#gotoIDE").click(Sn)}),window.location.search=="?printmeta"){let i=function(){var x="";it.forEach(l=>{l&&(x+="* "+l.name+" - "+Er(l)+`
`)}),console.log(x)};var t=i;i()}}On();export{ne as dithertron,On as startUI};
